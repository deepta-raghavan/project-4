 ...
 *  Dependencies: EdgeWeightedDigraph.java IndexMinPQ.java Stack.java NetworkEdge.java
...
public class DijkstraSP {
    ...
    private NetworkEdge[] edgeTo;    // edgeTo[v] = last edge on shortest s->v path
     ...
     */
    public DijkstraSP(ComputerNetwork G, int s) {
    ...
    private boolean check(ComputerNetwork G, int s) {
